...
@Entity
public class ChildrenMethod implements Parcelable {
    ...
    protected ChildrenMethod(Parcel in) {
    ...
    public static final Creator<ChildrenMethod> CREATOR = new Creator<ChildrenMethod>() {
        @Override
        public ChildrenMethod createFromParcel(Parcel source) {
            return new ChildrenMethod(source);
        }

        @Override
        public ChildrenMethod[] newArray(int size) {
            return new ChildrenMethod[size];
        }
    };
}
